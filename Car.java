public class Car
{
   ...
   */
    ...
    * same name name as class (car)
    * how to make/declare objects in main - car();
    *
     4 attributes, getters/setters
    * printInfo and changePrice methods
    *
    * In general, a class can have
    * attributes (data)
    * constructor (s) - how to create obj
    * methods - behaviors (inputs and outputs)
